...
(function(window, document, Math) {
  ...
  Grid = (function() {
    ...
    Grid.prototype.draw = function() {
      ...
      this.elements.form.column.value = ((col - gutter) / pixelDensity).toFixed(2);
